...
function $RootScopeProvider() {
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    function Watcher(listener, initWatchVal, get, watchExp, objectEquality, scopeId) {
    ...
    Scope.prototype = {
      ...
      $watch: function(watchExp, listener, objectEquality) {
        ...
        var scope = this,
            ...
            watcher = new Watcher(listener, initWatchVal, get, watchExp, !!objectEquality, scope.$id);
